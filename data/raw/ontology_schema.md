...
**활용 목적**
- GraphRAG: 그래프 형식 JSON(노드/엣지)을 적재하여 조항 간 관계 탐색
...
## 13. GraphRAG 활용 예시 (그래프 탐색 질의)

> 그래프는 JSON(노드/엣지)으로 저장된다. 아래는 노드/엣지 관계를 보여주는 개념 예시이며, 표기는 그래프 질의 의사코드(pseudo-Cypher)다.
