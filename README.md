...
본 프로젝트는 KASB(한국회계기준원)의 일반기업회계기준 등의 데이터를 활용합니다. 
저작권 보호를 위해 저장소에는 원본 및 전문이 포함된 파생 파일이 포함되어 있지 않습니다.
개발을 위해 로컬 환경에 데이터를 적재하는 방법은 [`scripts/download_corpus.md`](scripts/download_corpus.md)를 참고해 주세요.

> **[TBD] KASB 저작권 정책 확인 필요**  
> 현재는 로컬 개발 전용으로 운영되며, 향후 서비스 공개 또는 배포와 관련된 공식 저작권 정책은 별도 안내 대기 중입니다.
